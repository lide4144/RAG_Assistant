...
class ClaimCitationBindingTests(unittest.TestCase):
    def test_binding_keeps_llm_answer_when_claims_are_bound(self) -> None:
        claim_plan = [
            {"claim": "A improves B", "chunk_id": "c1", "paper_id": "p1", "section_page": "p.1"},
            {"claim": "C outperforms D", "chunk_id": "c2", "paper_id": "p2", "section_page": "p.2"},
        ]
        ...
        evidence_grouped = [
            {"paper_id": "p1", "evidence": [{"chunk_id": "c1", "section_page": "p.1", "quote": "A improves B"}]},
            {"paper_id": "p2", "evidence": [{"chunk_id": "c2", "section_page": "p.2", "quote": "C outperforms D"}]},
        ]
    ...
    def test_binding_falls_back_to_staged_when_claims_not_bound(self) -> None:
        ...
        self.assertIn("claim -> citation", bound_answer)
        self.assertEqual(len(bound_citations), 2)
